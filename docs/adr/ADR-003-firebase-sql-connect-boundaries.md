...
> **parked**. TypeScript apps use Firestore Admin SDK / `@black-book/firebase` for the production
...
|--------|------------------|------------------------|
| `@black-book/data-access` | Postgres helpers parked; Firestore module is primary | Live Admin SDK wrappers after generate |
...
8. Generated server-side TypeScript SDK lives behind `@black-book/data-access` (or successor); apps do not embed ad-hoc SQL strings for user-shaped queries.
