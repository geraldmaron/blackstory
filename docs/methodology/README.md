...
| [`lives-across-decades.md`](./lives-across-decades.md) | How region × decade × group × class-tier cells are tabulated from IPUMS USA: groups, measurement regimes (work-based class before 1940, income tiers after), suppression, margins, and what the surface may say |
...
- Web methodology page — `apps/web/src/app/methodology/` (`/methodology`)
- Developer docs mirror — `apps/docs/content/methodology.md`

Research pipeline and ops memos live under `docs/research/`.
