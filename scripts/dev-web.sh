...
echo "dev-web: starting @repo/web on http://localhost:${PORT}/ (includes /admin — staff sign-in"
echo "  needs apps/web/.env.local with ADMIN_DATABASE_URL + Supabase config; see .env.example)"
