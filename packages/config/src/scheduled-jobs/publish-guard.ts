/**
 * The non-negotiable invariant for this whole bead: automation cannot publish. This module does
 * not reimplement that guard — it calls straight through to BB-039's assertDiscoveryCannotPublish
 ...
 */
import { assertDiscoveryCannotPublish, type DiscoveryOperationAttempt } from '@black-book/domain';
