...
export const DEFAULT_SCHEDULED_JOBS: readonly ScheduledJobDefinition[] = [
  ...
  // --- REAL: quarterly banned-books listing refresh. Re-validates curated catalog rows and
  // purchase-link reachability; emits snapshot proposals only — never auto-publishes.
  {
