...
export const mapFeaturePropertiesV1Schema = z.object({
...
const pointGeometryV1Schema = z.object({
  type: z.literal('Point'),
  coordinates: z.tuple([z.number().min(-180).max(180), z.number().min(-90).max(90)]),
});

export const mapFeatureV1Schema = z.object({
...
export const mapSourceV1Schema = z.object({
