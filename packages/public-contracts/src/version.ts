 ...
 * store analytics (analytics) show a non-trivial installed base still pinned to it. Nothing reads
 ...
 * retirement is always an explicit, evidence-gated, never a timer
