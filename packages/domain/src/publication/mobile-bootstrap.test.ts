...
test('ADR-023 staleness: a client stamp mismatch (or absence) is stale, a match is fresh', () => {
...
test('ADR-022 client floor: below min app build or wrong api version is incompatible', () => {
