/**
 * Search index construction with defense-in-depth notability-gate enforcement (BB-049 AC5).
 *
 * BB-049 AC5 requires that every published search result carries at least one `notabilityBasis` —
