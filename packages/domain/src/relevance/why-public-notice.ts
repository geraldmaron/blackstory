/**
 * BB-054 trauma-content notice derivation (BB-054 Deliver #4). Decides WHEN a trauma-content
 ...
 * it composes the existing BB-095 `sensitive_content` registry entry (../disclaimers.js), the
