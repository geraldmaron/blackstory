/**
 * Re-export shim: the implementation lives in @repo/domain-core/relationship.
 *
 ...
 *
 * Keep this file so relative imports of './relationship.js' inside @repo/domain resolve.
 */
