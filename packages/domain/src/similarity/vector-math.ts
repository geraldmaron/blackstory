 ...
 *
 * Deliberately duplicated (in miniature) from @repo/firebase's embeddings/vector-math.ts
 * rather than imported: @repo/firebase depends on @repo/domain (not the reverse),
