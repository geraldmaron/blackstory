/**
 * Re-export shim: the implementation lives in @repo/domain-core/claims/measurements.
 *
 ...
 *
 * Keep this file so relative imports of './claims/measurements.js' inside @repo/domain resolve.
 */
