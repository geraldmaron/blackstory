/**
 * Re-export shim: the implementation lives in @repo/domain-core/claims/confidence.
 *
 ...
 *
 * Keep this file so relative imports of './claims/confidence.js' inside @repo/domain resolve.
 */
