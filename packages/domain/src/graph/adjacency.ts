/**
 * Re-export shim: the implementation lives in @repo/domain-core/graph/adjacency.
 *
 ...
 *
 * Keep this file so relative imports of './graph/adjacency.js' inside @repo/domain resolve.
 */
