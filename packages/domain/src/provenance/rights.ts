/**
 * Re-export shim: the implementation lives in @repo/domain-core/provenance/rights.
 *
 ...
 *
 * Keep this file so relative imports of './provenance/rights.js' inside @repo/domain resolve.
 */
