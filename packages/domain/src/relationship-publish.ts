/**
 * Composable relationship publication validators with narrow inputs. A caller must invoke them
 * before publication; standalone validation functions do not establish integration coverage.
 */
import {
