...
export const PREDICATE_TEMPORAL_FAMILIES: readonly PredicateFamily[] = [
  { id: 'birth', property: 'start', test: /\b(birth|born|birth_year|birthdate|date_of_birth)\b/u },
  {
    id: 'death',
    property: 'end',
    test: /\b(death|died|death_year|deathdate|date_of_death|deceased)\b/u,
  },
  {
    id: 'founded',
    property: 'start',
  ...
  },
  {
    id: 'closed',
    property: 'end',
    test: /\b(closed|dissolved|disbanded|ceased|shut_down|shutdown)\b/u,
  },
  ...
  },
  {
    ...
    test: /\b(event_date|occurred|occurred_on|occurred_in|held_on)\b/u,
  },
];
