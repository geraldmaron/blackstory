...
export const CENSUS_COUNTY_BLACK_POPULATION_SERIES_ID =
  CENSUS_COUNTY_BLACK_POPULATION_SERIES.metricId;
export const CENSUS_COUNTY_TOTAL_POPULATION_SERIES_ID =
  CENSUS_COUNTY_TOTAL_POPULATION_SERIES.metricId;
