...
export const THEME_IMPACT_QUESTIONS: readonly ThemeImpactQuestion[] = [
  ...
  },
  {
    ...
    metricBindings: [
      ...
      { kind: 'phase1', metricId: 'nhgis-white-population-share-county' },
      { kind: 'phase1', metricId: 'nhgis-homeownership-rate-black-county' },
      { kind: 'phase1', metricId: 'nhgis-homeownership-rate-white-county' },
  ...
  },
  {
    ...
    metricBindings: [
      { kind: 'phase1', metricId: 'acs-black-population-share-county' },
      { kind: 'phase1', metricId: 'cdc-eji-environmental-burden-score-county' },
      { kind: 'phase1', metricId: 'epa-tri-facility-count-county' },
    ],
    artifactClasses: ['peer_reviewed_synthesis', 'primary_government_document'],
  },
  {
