...
export const PHASE1_HMDA_INDICATOR_DEFINITIONS: readonly Phase1IndicatorDefinition[] = [
  ...
  series({
    ...
    metricDefinition:
      'Mortgage application denial rate for Black or African American applicants (HMDA national aggregate)',
    universe: 'home mortgage applications (actions taken 1–3; conventional purchase)',
    unit: 'percent',
    sourceDataset: 'FFIEC HMDA Data Browser',
    sourceTable: 'aggregations',
    sourceVariable: 'derived_race denial rate',
  ...
  series({
    ...
    metricDefinition:
      'Mortgage application denial rate for White, Non-Hispanic applicants (HMDA national aggregate)',
    universe: 'home mortgage applications (actions taken 1–3; conventional purchase)',
    unit: 'percent',
    sourceDataset: 'FFIEC HMDA Data Browser',
    sourceTable: 'aggregations',
  ...
  series({
    ...
    metricDefinition:
      'Black minus White, Non-Hispanic mortgage application denial rate gap (percentage points, HMDA national aggregate)',
    universe: 'home mortgage applications (actions taken 1–3; conventional purchase)',
    unit: 'percentage_points',
    sourceDataset: 'FFIEC HMDA Data Browser',
    sourceTable: 'aggregations',
