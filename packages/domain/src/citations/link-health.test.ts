 ...
 * `@repo/security` is a devDependency of this package for exactly this kind of proof (see
 ...
 */
test('the link-health port adapts a real executeSafeFetch(...) result from @repo/security', async () => {
