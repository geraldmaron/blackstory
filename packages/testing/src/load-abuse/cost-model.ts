 ...
 * Uses relative policy units, not measured resource use or provider billing.
 */
import {
...
export function estimateScenarioCosts(): readonly CostEstimate[] {
  ...
  return [
    ...
    },
    {
      ...
      notes:
        'Database query work is bounded by guardrails; request overhead remains even when denied.',
    },
    {
    ...
    },
    {
      ...
      notes: `External geocoder request budget; daily hard stop at ${geocoderDaily} requests.`,
    },
    {
    ...
    },
    {
      ...
      notes: 'Concurrency slots held until timeout; request duration holds server resources.',
    },
    {
