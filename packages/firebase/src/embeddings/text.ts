 ...
 *
 * Decade-bucketing math delegates to @blap/domain's shared `deriveEraBuckets` (
 ...
 */
import { deriveEraBuckets } from '@blap/domain';
 ...
 * `deriveEraBuckets` (@blap/domain) — the anchor resolves to exactly one decade
