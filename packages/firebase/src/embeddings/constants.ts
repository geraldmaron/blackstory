/**
 * Embedding pipeline and Firestore vector-search constants (BB-071).
 *
 ...
 * ADR-014; budget/cost docs under docs/security/ are out of this bead's file ownership.
 */
...
/**
 * Rough embedding cost anchor from the bead brief: ~$7.50 to embed 100k docs of ~500 tokens
