...
export const DEMO_PROJECT_ID = 'demo-blap' as const;
...
export const FIREBASE_PACKAGE = '@blap/firebase' as const;

export const PRODUCTION_BREAK_GLASS_ENV = 'BLAP_FIREBASE_ALLOW_PRODUCTION' as const;
