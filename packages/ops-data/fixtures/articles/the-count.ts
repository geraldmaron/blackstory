...
export const theCountArticle = {
  ...
  body: [
    ...
    {
      type: 'paragraph',
      text: 'Then, inside a single decade, the record changes shape, and for one January evening it even changes hands. On the twelfth of January, 1865, in a house in Savannah, twenty Black ministers and church officers sit down with the Secretary of War and General Sherman, and a clerk takes minutes. The men choose Garrison Frazier, a Baptist minister who bought freedom for himself and his wife with a thousand dollars in gold and silver, to answer for them, and when he is asked what his people need, his answer goes into the record in his own words: "The way we can best take care of ourselves is to have land, and turn it and till it by our own labor" [ref:fssp-savannah-colloquy]. Question by question, the minutes preserve a thing the previous two and a half centuries of American paper almost never contain: Black men asked on the record what they want, and the answers written down as given. The document runs only a few pages. Four days later Sherman answers it with Special Field Orders No. 15, setting aside the coastal land for settlement by the freed people, and within the year President Johnson’s pardons send that land back to the men who held it before the war [ref:special-field-orders-15]. What outlasts the land is the paper. Notice how rare the document’s shape is, an interview instead of an inventory, and how short its season was.',
    },
    {
      type: 'paragraph',
