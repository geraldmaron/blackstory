...
ON CONFLICT (id) DO UPDATE SET
  title = EXCLUDED.title, summary = EXCLUDED.summary, policy_eras = EXCLUDED.policy_eras,
  geography = EXCLUDED.geography, method_stance = EXCLUDED.method_stance, method_note = EXCLUDED.method_note,
  observations = EXCLUDED.observations, derived = EXCLUDED.derived, artifacts = EXCLUDED.artifacts,
  gap_states = EXCLUDED.gap_states, status = EXCLUDED.status, updated_at = EXCLUDED.updated_at
RETURNING id;