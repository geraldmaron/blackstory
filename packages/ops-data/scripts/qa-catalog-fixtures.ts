 ...
 *
 * Usage:
 *   node --conditions development --import tsx packages/ops-data/scripts/qa-catalog-fixtures.ts \
 *     [--dir=packages/ops-data/fixtures/national-catalog] [--candidate-dir=/path/to/new-files]
