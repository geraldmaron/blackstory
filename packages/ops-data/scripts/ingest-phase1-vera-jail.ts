 ...
 * observations into reference.statistical_observations.
 *
 * Usage (repo root):
 *   # Dry-run (default) — bounded to GA+MD unless PHASE1_VERA_ALL_COUNTIES=1
 *   node --conditions development --import tsx \
 *     packages/ops-data/scripts/ingest-phase1-vera-jail.ts
 *
 ...
 *   node --conditions development --import tsx \
 *     packages/ops-data/scripts/ingest-phase1-vera-jail.ts \
 *     --vera-csv=packages/ops-data/fixtures/reference-indicators/vera-county-snippet.csv
 */
