 ...
 *     packages/ops-data/scripts/wire-slug-mentions-and-orgs.ts
 *
 * If a prior run flooded related[], repair with:
 *   node --conditions development --import tsx \
 *     packages/ops-data/scripts/narrow-related-wiring.ts
 */
...
const CATALOG_DIR = join(ROOT, 'packages/ops-data/fixtures/national-catalog');
