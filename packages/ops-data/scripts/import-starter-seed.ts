 ...
 *   packages/ops-data/fixtures/national-catalog/starter-seed-2026-07.json
 ...
 *
 * Usage:
 *   node --conditions development --import tsx packages/ops-data/scripts/import-starter-seed.ts
 */
...
const seedPath = join(
  repoRoot,
  'packages/ops-data/fixtures/seed-programs/blackstory-starter-2026-07/blackstory_verified_starter_records.jsonl',
);
