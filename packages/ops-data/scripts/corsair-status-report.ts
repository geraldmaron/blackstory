 ...
 *
 * Usage:
 *   node --conditions development --import tsx packages/ops-data/scripts/corsair-status-report.ts
 *   node --conditions development --import tsx packages/ops-data/scripts/corsair-status-report.ts --json
 */
