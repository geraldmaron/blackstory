 ...
 *
 * Usage:
 *   node --conditions development --import tsx packages/ops-data/scripts/discover-candidates.ts \
...
const CANDIDATES_DIR =
  process.env.DISCOVERY_CANDIDATES_DIR?.trim() || join(REPO_ROOT, 'data/discovery-candidates');
