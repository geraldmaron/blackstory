/**
 * Converting census dollars to 2024 dollars for Lives Across the Decades.
 *
 * CPI-U-RS (BLS research series, current methods) is used from its 1978 base onward and
 * linked to CPI-U for 1913–1977 by rescaling CPI-U to CPI-U-RS at the link year. The chained
 * index is stored as its own statistical series so every conversion can be reproduced.
 */
