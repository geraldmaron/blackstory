          ...
          positions: [
            {
              ...
              claim: 'Yes.',
              heldBy: ['Someone'],
              citationUrl: base.evidence[0]!.sourceUrl,
            },
            {
              label: 'B',
              claim: 'No.',
              heldBy: ['Someone else'],
              citationUrl: base.canonicalSource.url,
            },
          ],
          ...
          positions: [
            {
              ...
              claim: 'Yes.',
              heldBy: ['Someone'],
              citationUrl: 'https://example.org/elsewhere',
            },
            {
              label: 'B',
              claim: 'No.',
...
test('predicted claim ids follow the publisher’s own numbering', () => {
  ...
  assert.equal(
    predictedClaimId('ent_case_example_v_texas_1954', 1),
    'claim_case_example_v_texas_1954_02',
  );
});
...
test('document keys match on host and path, ignoring www and a trailing slash', () => {
  assert.equal(
    documentKeyForUrl('https://www.example.gov/a/b/'),
    documentKeyForUrl('https://example.gov/a/b'),
  );
  assert.notEqual(
    documentKeyForUrl('https://example.gov/a'),
    documentKeyForUrl('https://example.gov/b'),
  );
