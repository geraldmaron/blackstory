 ...
 * Structurally mirrors `packages/ops-data/src/embeddings/backfill-cli.ts`: every dependency
 ...
 * packages/ops-data/src/jurisdictions/load-cli.ts --gazetteer-file /path/to/2024_Gaz_counties_national.txt
 *
