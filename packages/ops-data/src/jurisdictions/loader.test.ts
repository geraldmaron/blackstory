 ...
 * Uses an injected in-memory writer no database/network dependency, matching
...
/** In-memory record writer: same idempotent compare-then-set logic the real CLI uses. */
