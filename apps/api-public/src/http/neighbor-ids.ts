/**
 * Bounded 1-hop / 2-hop neighbor id collection for live entity hydration.
 * Mirrors `apps/web/src/lib/public-data/neighbor-ids.ts` so api-public and web share caps.
 */
