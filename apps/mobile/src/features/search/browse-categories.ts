 ...
 * `ENTITY_KINDS` allow-list `apps/mobile/src/app/_lib/route-params.ts` already validates route
 ...
 */
import { ENTITY_KINDS, type EntityKind } from '../../app/_lib/route-params';
