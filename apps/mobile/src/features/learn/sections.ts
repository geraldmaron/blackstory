...
export const LEARN_SECTIONS: readonly LearnMoreSectionRow[] = [
  {
    routeId: 'history',
    title: 'History',
    subtitle: 'Decade-by-decade context (web: /history)',
  ...
  },
  {
    routeId: 'myths',
    title: 'Myths',
    subtitle: 'Common misconceptions, corrected (web: /myths)',
    catalogSection: 'myths',
  },
  {
    routeId: 'methodology',
    title: 'Methodology',
    subtitle: 'How records are researched and verified (web: /methodology)',
