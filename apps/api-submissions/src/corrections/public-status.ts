/**
 * Maps internal moderation states to public-safe status surfaces for the corrections
 * intake route. Never exposes spam scores, campaign detection, duplicate lists, or other
