/**
 * robots.txt (BB-089 perimeter hygiene). Standard search engines may index the public corpus;
 ...
 * Review periodically (fold into BB-084's scheduled maintenance) as new agents appear.
 */
