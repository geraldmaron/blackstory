...
const AFTER_SUBMIT_STEPS: readonly React.ReactNode[] = [
  ...
  <>
    Read <Link href="/methodology">how disputes and review are handled</Link> on the methodology
    page.
  </>,
] as const;
      ...
      <div className="ds-corrections__inner">
        ...
        <div className="ds-entity-sections">
          ...
          >
            ...
            <Notice
              className="ds-corrections__callout"
              tone="warning"
              title="This is not a public post"
            >
          ...
          >
            ...
            <p className="ds-section__lede">
              Point to the record, describe what should change, and cite a supporting source.
              Optional contact details stay with moderators only.
            </p>
        ...
        <section
          className="ds-section ds-corrections__next"
          aria-labelledby="next-corrections"
          id="next"
        >
