 ...
 * import this file from a Client Component: it pulls in `@repo/firebase`'s Admin SDK
 * surface.
 *
 ...
 *
 * The `@repo/firebase` import below is a dynamic `import`, not a static one, for the same
