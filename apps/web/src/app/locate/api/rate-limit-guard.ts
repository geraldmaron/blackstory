 ...
 * `@blap/security` `createRateLimitEvaluator`, `buildRateLimitKey`,
 ...
 * `@blap/security`'s policy matrix (`DEFAULT_ENDPOINT_QUOTA_MATRIX` in `rate-limits.ts`)
 ...
 * `GEOCODING_ENDPOINT_CLASS` constant in `@blap/security` today (only `SEARCH_ENDPOINT_CLASS`
