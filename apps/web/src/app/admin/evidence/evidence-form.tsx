          ...
          <div>
            ...
            <div className="ds-notice__body">
              <p>
                ...
                <Link href={`/admin/cases/${state.researchCaseId}`}>{state.researchCaseId}</Link>.
              </p>
              <p>
                Check commit and submit again to persist, or{' '}
                <Link href="/admin/inbox">open inbox</Link> to continue triage.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="ds-notice" role="status">
          ...
          <div>
            ...
            <div className="ds-notice__body">
              ...
              <p>
                <Link href={`/admin/cases/${state.researchCaseId}`}>Open case</Link>
                {' · '}
