...
import type { MergeCandidate } from '../../../../admin/lib/entity-merge';
  ...
  if (state.status === 'ok') {
    return (
      <div className="entity-merge__done">
        ...
        <p>
          <Link href={`/admin/catalog/${encodeURIComponent(state.survivorId ?? survivorId)}`}>
  ...
  return (
    <form action={formAction} className="entity-merge__form">
      ...
      <div className="entity-edit__actions">
        ...
        <Link href="/admin/catalog" className="entity-merge__cancel">
          Cancel
        </Link>
      </div>
    </form>
