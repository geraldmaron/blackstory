 ...
 *
 * Reached from the workbench with a selection (`/admin/catalog/merge?ids=a,b,c`). The page is a preview:
...
import { readMergeCandidates } from '../../../../admin/lib/entity-merge';
import { MAX_ABSORBED_PER_MERGE } from '../../../../admin/lib/entity-merge-plan';
