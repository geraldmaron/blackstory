...
import { BULK_CONFIRM_THRESHOLD, describeBulkEdit } from '../../../admin/lib/entity-bulk-edit';
import {
  ENTITY_KINDS,
  LIVING_STATUSES,
  entityClassForKind,
} from '../../../admin/lib/entity-vocabulary';
import type { EntityKind } from '../../../admin/lib/entity-vocabulary';
