/**
 * Readable Law apparatus for `/apparatus#law`. Browse and filter tools live at `/law/browse`.
 */
...
export type LawApparatusSectionsProps = {
  readonly source: LegalCatalogSource;
};

export function LawApparatusSections({ source }: LawApparatusSectionsProps) {
