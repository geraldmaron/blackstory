/**
 * Degraded read-only mode helpers (BB-022).
 *
 ...
 * for immutable release snapshots until BB-019 projection fetchers land.
 *
 ...
 * `liveFetch` will be wired to api-public in BB-019; until then callers pass seed reads.
 */
