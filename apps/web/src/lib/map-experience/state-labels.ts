...
export const STATE_LABEL_CLASS_NAME = 'bb-state-label';
export const STATE_LABEL_SELECTED_CLASS_NAME = 'bb-state-label--selected';
...
export function buildStateLabelElement(descriptor: StateLabelMarkerDescriptor): HTMLDivElement {
  ...
  el.style.fontFamily = 'var(--bb-font-mono)';
