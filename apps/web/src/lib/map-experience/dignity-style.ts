/**
 * Dignity-rule style tokens for the BB-051 map (acceptance criteria: no red violence markers, no
 * trauma-forward color coding, clusters never render as crime-heat). Every color below comes from
 * `@black-book/ui`'s brand palette (BB-068) — this module never introduces a new hue. The
 ...
 * individual points (BB-051 "narrative off-ramps at every zoom" acceptance criterion). */
