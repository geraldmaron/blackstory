...
import { listPublicEntityViews, type PublicReadSource } from '../public-data/source';
...
/** Builds the ONE base feature collection + style a surface can hand to `MapStageProvider`
