  ...
  },
{
  ...
  },
  {
    ...
    publishedDate: '1937',
    challenges: [{ state: 'FL', jurisdictionLabel: "Collier County Public Schools", schoolYear: "2023-2024", status: 'reported', citation: PEN_INDEX_2024, challengeYear: 2023 }, { state: 'VA', jurisdictionLabel: "Stonewall Jackson High School (Prince William County Public Schools)", status: 'rescinded', citation: { label: "Their Eyes Were Watching God — FIRE First Amendment Library", href: "https://www.thefire.org/first-amendment-library/special-collections/banned-challenged-book/their-eyes-were-watching-god/", publisher: "FIRE" }, challengeYear: 1997 }],
    citations: [{ label: "Their Eyes Were Watching God — FIRE First Amendment Library", href: "https://www.thefire.org/first-amendment-library/special-collections/banned-challenged-book/their-eyes-were-watching-god/", publisher: "FIRE" }, PEN_INDEX_2024, { label: "Read These Banned Books By Black Authors", href: "https://www.today.com/popculture/books/banned-books-black-authors-list-rcna193062", publisher: "TODAY", publishedAt: "2024-02" }],
  ...
  },
  {
    ...
    publishedDate: '1973',
    challenges: [{ state: 'VA', jurisdictionLabel: "Madison County Public Schools", schoolYear: "2022-2023", status: 'reported', citation: PEN_INDEX_2023, challengeYear: 2023 }, { state: 'FL', jurisdictionLabel: "Collier County Public Schools", schoolYear: "2023-2024", status: 'reported', citation: PEN_INDEX_2024, challengeYear: 2023 }],
  ...
  },
  {
    ...
    publishedDate: '1979',
    challenges: [{ state: 'MO', jurisdictionLabel: "Wentzville School District", schoolYear: "2022-2023", titleAtChallenge: "Kindred: A Graphic Novel Adaptation", status: 'reported', citation: PEN_INDEX_2023, challengeYear: 2022 }],
  ...
  },
  {
    ...
    publishedDate: '1845',
    challenges: [{ state: 'OK', jurisdictionLabel: "Edmond Public Schools (disputed curriculum removal; district denies a ban)", schoolYear: "2021-2022", challengeYear: 2021, status: 'reported', citation: { label: "Lawsuit alleges book banning related to new Oklahoma law", href: "https://kfor.com/news/local/lawsuit-alleges-book-banning-related-to-new-oklahoma-law/", publisher: "KFOR", publishedAt: "2021-10" } }],
  ...
  },
  {
    ...
    publishedDate: '2018',
    challenges: [{ state: 'PA', jurisdictionLabel: "Central York School District", schoolYear: "2021-2022", challengeYear: 2021, status: 'rescinded', citation: { label: "Student Action Results in Decision by School Board to “Unfreeze” Anti-Racist Resources in Central York, PA", href: "https://www.oif.ala.org/student-action-results-in-decision-by-school-board-to-unfreeze-anti-racist-resources-in-central-york-pa/", publisher: "ALA Office for Intellectual Freedom", publishedAt: "2021-09" } }],
  ...
  },
  {
    ...
    publishedDate: '2019',
    challenges: [{ state: 'FL', jurisdictionLabel: "St. Johns County School District", challengeYear: 2023, status: 'reported', citation: PEN_INDEX_2024 }, { state: 'FL', jurisdictionLabel: "Lee County Schools", challengeYear: 2024, status: 'reported', citation: PEN_INDEX_2024 }, { state: 'PA', jurisdictionLabel: "Central York School District", challengeYear: 2021, status: 'rescinded', citation: { label: "Pennsylvania school district reverses ban on books by authors of colour", href: "https://www.theguardian.com/books/2021/sep/22/pennsylvania-school-district-reverses-ban-on-books-by-authors-of-colour", publisher: "The Guardian", publishedAt: "2021-09-22" } }],
    citations: [PEN_INDEX_2024, { label: "On the Come Up censorship history (PEN America aggregates)", href: "https://www.banned-books.org/books/on-the-come-up", publisher: "Banned Books" }, { label: "Pennsylvania school district reverses ban on books by authors of colour", href: "https://www.theguardian.com/books/2021/sep/22/pennsylvania-school-district-reverses-ban-on-books-by-authors-of-colour", publisher: "The Guardian", publishedAt: "2021-09-22" }],
  ...
  },
  {
    ...
    publishedDate: '2021',
    challenges: [{ state: 'FL', jurisdictionLabel: "Clay County School District", challengeYear: 2023, status: 'reported', citation: { label: "PEN America Index of School Book Bans 2022–2023 (PDF)", href: "https://thisbookisbanned.com/wp-content/uploads/2024/10/PEN-Americas-Index-of-School-Book-Bans-July-1-2022-June-30-2023-Sorted-by-State-District.pdf" } }, { state: 'TX', jurisdictionLabel: "Conroe Independent School District", challengeYear: 2023, status: 'reported', citation: { label: "Your Conroe News — Conroe ISD review of Black Boy Joy", href: "https://www.yourconroenews.com/neighborhood/moco/news/article/conroe-isd-book-policy-defines-sexually-explicit-18491478.php" } }],
  ...
  },
  {
    ...
    publishedDate: '2020',
    challenges: [{ state: 'FL', jurisdictionLabel: "Hernando County School District", challengeYear: 2023, status: 'reported', citation: PEN_INDEX_2024 }, { state: 'FL', jurisdictionLabel: "Volusia County School District", challengeYear: 2023, status: 'reported', citation: PEN_INDEX_2023 }, { state: 'TN', jurisdictionLabel: "Wilson County Schools", challengeYear: 2024, status: 'reported', citation: { label: "Nashville Banner — Wilson County bans include Felix Ever After", href: "https://nashvillebanner.com/2024/10/25/wilson-county-bans-390-books/" } }],
    citations: [PEN_INDEX_2024, PEN_INDEX_2023, { label: "Nashville Banner — Wilson County bans include Felix Ever After", href: "https://nashvillebanner.com/2024/10/25/wilson-county-bans-390-books/" }],
  ...
  },
  {
    ...
    publishedDate: '2020',
    challenges: [{ state: 'PA', jurisdictionLabel: "Central York School District", challengeYear: 2021, status: 'rescinded', citation: PEN_INDEX_2022 }, { state: 'UT', jurisdictionLabel: "Nebo School District", challengeYear: 2022, status: 'reported', citation: PEN_INDEX_2023 }, { state: 'FL', jurisdictionLabel: "Collier County Public Schools", challengeYear: 2024, status: 'reported', citation: PEN_INDEX_2024 }, { state: 'FL', jurisdictionLabel: "Escambia County Public Schools", challengeYear: 2023, status: 'reported', citation: PEN_INDEX_2024 }, { state: 'IA', jurisdictionLabel: "Shenandoah Community School District", challengeYear: 2024, status: 'reported', citation: PEN_INDEX_2024 }],
    citations: [PEN_INDEX_2024, PEN_INDEX_2023, PEN_INDEX_2022, { label: "Banned Books — Clap When You Land challenge records", href: "https://www.banned-books.org/books/clap-when-you-land" }],
  ...
  },
  {
    ...
    publishedDate: '2018',
    challenges: [{ state: 'FL', jurisdictionLabel: "Clay County School District", challengeYear: 2024, status: 'reported', citation: PEN_INDEX_2024 }],
    citations: [PEN_INDEX_2024, PEN_BOOK_BANS, NPR_ALA_2024],
  ...
  },
  {
    ...
    publishedDate: '2017',
    challenges: [{ state: 'TN', jurisdictionLabel: "Knox County Schools", challengeYear: 2024, status: 'reported', citation: { label: "Knox News — Knox County Schools pulls 48 books including The 57 Bus", href: "https://www.knoxnews.com/story/news/education/2024/12/05/knox-county-schools-pulls-48-books-in-accordance-with-tennessee-law/76770330007/" } }, { state: 'TX', jurisdictionLabel: "Katy Independent School District", challengeYear: 2024, status: 'reported', citation: { label: "PEN America Index of School Book Bans 2024–2025 (PDF)", href: "https://www.dallasobserver.com/wp-content/uploads/sites/3/2025/01/PEN-America-Index-of-School-Book-Bans-%E2%80%93-2024-2025-PEN-America.pdf", publisher: "PEN America" } }, { state: 'FL', jurisdictionLabel: "School District of Manatee County", challengeYear: 2022, status: 'reported', citation: PEN_INDEX_2023 }],
  ...
  },
  {
    ...
    publishedDate: '2018',
    challenges: [{ state: 'FL', jurisdictionLabel: "Escambia County Public Schools", challengeYear: 2023, status: 'reported', citation: PEN_INDEX_2024 }, { state: 'TX', jurisdictionLabel: "Katy Independent School District", challengeYear: 2022, status: 'reported', citation: PEN_INDEX_2022 }],
    citations: [PEN_INDEX_2024, PEN_INDEX_2022, { label: "PEN America v. Escambia County School District", href: "https://pen.org/pen-america-v-escambia-county/" }],
