 ...
 *
 * Not currently rendered: `/data` consumes typed `statistical_series` metrics, while this
 * component accepts the `HateCrimeYearSummary` rollup. Pairing every count with its participation
 * rate is required by docs/research/data-ingestion-methodology.md. Any adapter to typed
 * observations must preserve that pairing.
 */
