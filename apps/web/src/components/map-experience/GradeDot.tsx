 ...
 *
 * The three grades differ by fill treatment as well as hue, so the grade survives a grayscale
 * render and color is never the only signal (brand.md, design-direction-v9-atlas.md §8). An
 * ungraded record gets a hairline outline in the muted ink and the word "not graded" in its
 * label — never a fourth color, because "nobody assessed this" is not a weaker assessment.
 *
