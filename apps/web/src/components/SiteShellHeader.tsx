 ...
 *
 * One bar, every surface. Explore mounts its own `CommandBar` inside `AtlasExperience` with the
 * mode toggle, the palette, the saved drawer and the shortcut sheet (that surface's client state).
 * This renders the same component without them: brand, search, Find (Explore / Records), Rooms,
 * and the theme switch. Same component, same position, same artwork.
 *
